...
def assignment_dto(assignment: TicketAssignment) -> AssignmentDTO:
    return AssignmentDTO(
        ...
        project_version_id=assignment.metadata.get("project_version_id"),
        target_version_label=assignment.metadata.get("target_version_label"),
        issue_ticket_id=assignment.metadata.get("issue_ticket_id") or assignment.ticket_id,
        issue_ticket_key=assignment.metadata.get("issue_ticket_key") or assignment.ticket_key,
        selected_agent_id=assignment.metadata.get("selected_agent_id") or assignment.agent_id,
        runtime_backend_intent=_metadata_dict(assignment.metadata, "runtime_backend_intent"),
